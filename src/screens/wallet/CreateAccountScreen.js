...
export default class CreateAccountScreen extends Component {
    ...
    _onNext = () => {
        ...
        AsyncStorage.setItem(Constants.DEFAULT_WALLET_ACCOUNT, address)
            .then(() => {
                console.log('13123');
        ...
        AsyncStorage.getItem(Constants.DEFAULT_WALLET_ACCOUNT).then(console.log);
    }
}
